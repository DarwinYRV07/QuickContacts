...
/*
    ...
    const addNewContact =  (nombre, apellido, numero, empresa, email, grupo,direccion, nota) =>{
        return database.insertContacts(nombre, apellido, numero, empresa, email, grupo,direccion, nota, refreshContacts);
